...
public class YDialog extends YBaseDialog implements IDialog{
    ...
    public YDialog() {
        controller = new YDialogController(this);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (buildListener != null && getBaseView() != null) {
            buildListener.onBuildChildView(this, getBaseView(), getDialogLayoutRes());
        }
    }
    ...
    public static class Builder {
        private YDialogController.SYParams params;
        private IDialog.OnBuildListener buildListener;
        private IDialog.OnDismissListener dismissListener;
        ...
        private YDialog create() {
            YDialog dialog = new YDialog();
