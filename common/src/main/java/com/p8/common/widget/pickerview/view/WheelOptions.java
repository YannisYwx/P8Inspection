package com.p8.common.widget.pickerview.view;

import android.graphics.Typeface;
import android.view.View;

import com.p8.common.R;
import com.p8.common.widget.pickerview.adapter.ArrayWheelAdapter;
...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
        ...
        wv_option2.setCurrentItem(wv_option2.getCurrentItem());
        // 选项3
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        wv_option1.setAdapter(new ArrayWheelAdapter<>(options1Items));
        wv_option1.setCurrentItem(0);
    ...
    public void setSelectTextBackgroundColor(int backgroundColor) {
        wv_option1.setSelectTextBackgroundColor(backgroundColor);
        wv_option2.setSelectTextBackgroundColor(backgroundColor);
        wv_option3.setSelectTextBackgroundColor(backgroundColor);
    }
