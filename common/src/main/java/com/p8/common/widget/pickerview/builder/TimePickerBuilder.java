package com.p8.common.widget.pickerview.builder;
...
import com.p8.common.widget.pickerview.configure.PickerOptions;
import com.p8.common.widget.pickerview.listener.CustomListener;
import com.p8.common.widget.pickerview.listener.OnTimeSelectChangeListener;
import com.p8.common.widget.pickerview.listener.OnTimeSelectListener;
import com.p8.common.widget.pickerview.view.TimePickerView;
...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setLabel(String labelYear, String labelMonth, String labelDay, String labelHours, String labelMins, String labelSeconds) {
        mPickerOptions.label_year = labelYear;
        mPickerOptions.label_month = labelMonth;
        mPickerOptions.label_day = labelDay;
        mPickerOptions.label_hours = labelHours;
        mPickerOptions.label_minutes = labelMins;
        mPickerOptions.label_seconds = labelSeconds;
        return this;
    }
    ...
    public TimePickerBuilder setTextXOffset(int xOffsetYear, int xOffsetMonth, int xOffsetDay,
        ...
        mPickerOptions.x_offset_year = xOffsetYear;
        mPickerOptions.x_offset_month = xOffsetMonth;
        mPickerOptions.x_offset_day = xOffsetDay;
        mPickerOptions.x_offset_hours = xOffsetHours;
        mPickerOptions.x_offset_minutes = xOffsetMinutes;
        mPickerOptions.x_offset_seconds = xOffsetSeconds;
        return this;
    }
