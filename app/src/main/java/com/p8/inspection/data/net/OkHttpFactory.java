...
import com.p8.inspection.data.net.interceptor.CacheControlInterceptor;
import com.p8.inspection.data.net.interceptor.ForceNetworkControlInterceptor;
...
public class OkHttpFactory {
    ...
    private static OkHttpClient getOkHttpClient(Interceptor cacheControl) {
        ...
        //设置缓存
        File httpCacheDirectory = new File(P8ParkingApplication.sInstance.getCacheDir(), "OkHttpCache");
