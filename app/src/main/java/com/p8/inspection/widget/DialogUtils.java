...
public class DialogUtils {
    ...
    public static void showClearCacheDialog(Context context, IDialog.OnClickListener listener) {
        createDefaultDialog(context, "警告", "是否删除应用缓存？", "确定", listener, "取消", IDialog::dismiss);
    }
     ...
     */
    public static void showMessageDialog(Context context, String title, String content, String btn1Str,
