...
public class CitySelect implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.tv_street) {
            //街道
        }
    }
    ...
    public Dialog dialog() {
        ...
        window.setWindowAnimations(R.style.FadeInPopWin);
    ...
    class SelectAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.mCheckView = convertView.findViewById(R.id.cv_select);
