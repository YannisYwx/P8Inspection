...
public class SlackLoadingView extends View {
        ...
        switch (mStep % 4) {
            case 0:
                for (int i = 0; i < mColors.length; i++) {
                    ...
                    drawCRLC(canvas, (mWidth >> 1) - mEntireLineLength / 2.2f, (mHeight >> 1) - mLineLength, (mWidth >> 1) - mEntireLineLength / 2.2f, (mHeight >> 1) + mEntireLineLength, mPaint, mCanvasAngle + i * 90);
                }
                break;
            case 1:
                for (int i = 0; i < mColors.length; i++) {
                    mPaint.setColor(mColors[i]);
                    drawCR(canvas, (mWidth >> 1) - mEntireLineLength / 2.2f, (mHeight >> 1) + mEntireLineLength, mPaint, mCanvasAngle + i * 90);
                }
                break;
            case 2:
                for (int i = 0; i < mColors.length; i++) {
                    mPaint.setColor(mColors[i]);
                    drawCRCC(canvas, (mWidth >> 1) - mEntireLineLength / 2.2f, (mHeight >> 1) + mCircleY, mPaint, mCanvasAngle + i * 90);
                }
                break;
            case 3:
                for (int i = 0; i < mColors.length; i++) {
                    mPaint.setColor(mColors[i]);
                    drawLC(canvas, (mWidth >> 1) - mEntireLineLength / 2.2f, (mHeight >> 1) + mEntireLineLength, (mWidth >> 1) - mEntireLineLength / 2.2f, (mHeight >> 1) + mLineLength, mPaint, mCanvasAngle + i * 90);
                }
                break;
            default:
                break;
    ...
    private void drawCRLC(Canvas canvas, float startX, float startY, float stopX, float stopY, Paint paint, int rotate) {
        canvas.rotate(rotate, (mWidth >> 1), (mHeight >> 1));
    ...
    private void startCRCCAnim() {
        ...
        ValueAnimator circleYAnim = ValueAnimator.ofFloat(mEntireLineLength, mEntireLineLength >> 2, mEntireLineLength);
    ...
    public abstract static class AnimatorListener implements Animator.AnimatorListener {
