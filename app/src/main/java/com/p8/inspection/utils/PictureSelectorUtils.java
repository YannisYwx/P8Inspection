...
public class PictureSelectorUtils {
    ...
    public static PictureParameterStyle getDefaultStyle() {
        ...
        // 标题栏字体颜色
        style.pictureTitleTextColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_white);
        // 相册右侧取消按钮字体颜色  废弃 改用.pictureRightDefaultTextColor和.pictureRightDefaultTextColor
        style.pictureCancelTextColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_white);
        // 相册列表勾选图片样式
        style.pictureCheckedStyle = R.drawable.picture_checkbox_selector;
        // 相册列表底部背景色
        style.pictureBottomBgColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_grey);
        // 已选数量圆点背景样式
        style.pictureCheckNumBgStyle = R.drawable.picture_num_oval;
        // 相册列表底下预览文字色值(预览按钮可点击时的色值)
        style.picturePreviewTextColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_fa632d);
        // 相册列表底下不可预览文字色值(预览按钮不可点击时的色值)
        style.pictureUnPreviewTextColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_white);
        // 相册列表已完成色值(已完成 可点击色值)
        style.pictureCompleteTextColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_fa632d);
        // 相册列表未完成色值(请选择 不可点击色值)
        style.pictureUnCompleteTextColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_white);
        // 预览界面底部背景色
        style.picturePreviewBottomBgColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.picture_color_grey);
        // 外部预览界面删除按钮样式
        ...
        style.pictureOriginalFontColor = ContextCompat.getColor(P8ParkingApplication.sInstance, R.color.white);
        // 外部预览界面是否显示删除按钮
